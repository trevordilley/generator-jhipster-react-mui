...
function askForClientTheme(meta) {
    ...
    if (this.clientFramework === 'react') {
        // TODO: Handle this differently, ideally make it a whole separate
        // prompt to ask (if react) to use reactstrap vs material-ui
        defaultChoices.push({ value: 'mui', name: 'Material-UI' });
    }
    const PROMPT = {
        type: 'list',
        name: 'clientTheme',
